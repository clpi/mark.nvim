...
M.setup = function(bufnr, actions)
  ...
  map("r", actions.refresh, "Refresh remote registries")
  map("s", actions.toggle_sort, "Toggle sort mode")
  map("c", actions.filter_category, "Filter by category")
  map("C", actions.clear_filter, "Clear category filter")
